...
// Type: LDChartControlPlus.ChartBar
...
public class ChartBar : UserControl
{
  ...
  public ChartBar()
  {
    ...
    float[] numArray = new float[4]{ 15f, 48f, 72f, 82f };
  ...
  protected override void OnPaint(PaintEventArgs e)
  {
    ...
    try
    {
      ...
      for (int index = 0; index <= num8; ++index)
      {
        ...
        int num12 = this.m_maxStepValueY - index * this.m_stepValueY;
      ...
      float num13 = rect1.Height / (float) this.m_maxStepValueY;
      ...
      for (int index1 = 0; index1 < this.m_itemsChart.Count; ++index1)
      {
        ...
        {
          string percentage = Function.GetPercentage(num16, this.m_itemsTotalValue, 2);
